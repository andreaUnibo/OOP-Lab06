...
public final class BaseRobotTest {
	...
	public void testRobotMovementBase() {
		...
		r1.moveUp();
		}catch (PositionOutOfBoundException e2) {
            assertTrue(e2.getMessage().contains("pos(" + RobotEnvironment.WORLD_X_UPPER_LIMIT + ", " + (RobotEnvironment.WORLD_Y_UPPER_LIMIT + 1) + ")"));
        } catch (NotEnoughBatteryException e3) {
